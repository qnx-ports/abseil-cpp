...
#define ABSL_TIME_CONSTEXPR_QNX inline
#else
#define ABSL_TIME_CONSTEXPR_QNX constexpr
#endif

ABSL_ATTRIBUTE_CONST_FUNCTION ABSL_TIME_CONSTEXPR_QNX int64_t ToInt64Nanoseconds(Duration d);
ABSL_ATTRIBUTE_CONST_FUNCTION ABSL_TIME_CONSTEXPR_QNX int64_t ToInt64Microseconds(Duration d);
ABSL_ATTRIBUTE_CONST_FUNCTION ABSL_TIME_CONSTEXPR_QNX int64_t ToInt64Milliseconds(Duration d);
ABSL_ATTRIBUTE_CONST_FUNCTION ABSL_TIME_CONSTEXPR_QNX int64_t ToInt64Seconds(Duration d);
ABSL_ATTRIBUTE_CONST_FUNCTION ABSL_TIME_CONSTEXPR_QNX int64_t ToInt64Minutes(Duration d);
ABSL_ATTRIBUTE_CONST_FUNCTION ABSL_TIME_CONSTEXPR_QNX int64_t ToInt64Hours(Duration d);
...
ABSL_ATTRIBUTE_CONST_FUNCTION ABSL_TIME_CONSTEXPR_QNX int64_t ToInt64Microseconds(
    Duration d) {
  if (time_internal::GetRepHi(d) >= 0 &&
...
ABSL_ATTRIBUTE_CONST_FUNCTION ABSL_TIME_CONSTEXPR_QNX int64_t ToInt64Milliseconds(
    Duration d) {
  if (time_internal::GetRepHi(d) >= 0 &&
